...
import { projects } from "../../data-20241007T042432Z-001/data/constants"; // Ensure this path is correct
...
const ToggleButtonGroup = styled.div`
  ...
  font-size: 16px;
  border-radius: 12px;
  font-weight: 500; /* Corrected typo */
  margin: 22px 0;
        ...
        <CardContainer>
          ...
          {toggle === "all" &&
            projects.map((project) => (
              <ProjectCard key={project.id} project={project} /> // Added key prop
            ))}
          {projects
